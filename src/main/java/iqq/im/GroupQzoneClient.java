...
import iqq.im.module.QunQzoneModule;
 ...
 * @author solosky
 */
public class GroupQzoneClient implements QQClient, QQContext {
	private static final Logger LOG = LoggerFactory.getLogger(GroupQzoneClient.class);
	 ...
	 */
	public GroupQzoneClient(String username, String password,
		...
		this.modules.put(QQModule.Type.QZONE, new QunQzoneModule());
	...
	public QQActionFuture getQunList(QQActionListener listener) {
		QunQzoneModule m = getModule(QQModule.Type.QZONE);
		return m.getQunList(listener);
	}
	/**
	 * {@inheritDoc}
	 *
